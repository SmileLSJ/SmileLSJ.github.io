---
layout:     post
title:      "RocketMQ技术内幕学习-05-消息消费--01--消息拉取"
...
* 消费逻辑图
  ...
  <img src="/img/13.png" alt="消费逻辑图"  />

* 消费逻辑精简的顺序图

  <img src="/img/04.png" alt="Consumer&Broker消费精简图.png" style="zoom:67%;" />
...
* ConsumeQueue结构
  ...
  ![ConsumeQueue、MappedFileQueue、MappedFile的关系](/img/03-20210827105523684.png)
...
* 类图
  ...
  ![image-20210813131921371](/img/image-20210813131921371.png)
...
* 类图
  ...
  <img src="/img/image-20210813133342012.png" alt="image-20210813133342012" style="zoom:50%;" />
...
* 核心流程
  ...
  ![https://note.youdao.com/yws/public/resource/ca36df22924e8930a550116b530b7ca5/xmlnote/75E4B1D45DF948EB9BFB3710211C7759/41488](/img/41488.png)
...
* 类图
  ...
  <img src="/img/image-20210813150130825.png" alt="image-20210813150130825" style="zoom:50%;" />
  ...
  * 疑问点
    ...
    * PullRequest是什么时间加入到阻塞队列中的呢？
      ...
      * 调用地方
        ...
        ![image-20210813152622022](/img/image-20210813152622022.png)

  * PullReqeust对象

    * 类图

    <img src="/img/image-20210813152904240.png" alt="image-20210813152904240" style="zoom:50%;" />
...
* 流程图
  ...
  <img src="/img/image-20210816163448951.png" alt="image-20210816163448951" style="zoom:50%;" />
...
* 类图：集成ServiceThread，可想而知是一个线程
  ...
  <img src="/img/image-20210816185016320.png" alt="image-20210816185016320" style="zoom:50%;" />
