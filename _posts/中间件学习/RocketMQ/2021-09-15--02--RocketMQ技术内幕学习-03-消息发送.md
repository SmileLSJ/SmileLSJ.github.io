...
* 类图
  ...
  <img src="/img/image-20210729154611796.png" alt="image-20210729154611796" style="zoom:50%;" />
...
![RocketMQ--消息生产者--启动流程](/img/RocketMQ--消息生产者--启动流程.jpg)
...
*  MQClientInstance # start
  ...
  * 其中，因为只有consumer是在启动的时候，和Broker进行负载均衡连接，所以，此处的客户端负载均衡是指消费者和Broker负载均衡分配
  * 而对于Producer而言，则是在发送消息的时候，获取到真正的服务器
...
![RocketMQ--消息生产者--发送消息](/img/RocketMQ--消息生产者--发送消息.jpg)

具体的方法图片

![Producer发送消息顺序图](/img/02-0029752.png)
...
* 生产者本地保存的主题的路由信息表
  ...
  <img src="/img/image-20210802151109835.png" alt="image-20210802151109835" style="zoom:50%;" />
