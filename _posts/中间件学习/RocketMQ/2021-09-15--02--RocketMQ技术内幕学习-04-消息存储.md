...
![RocketMQ技术内幕-04—消息存储](/img/RocketMQ技术内幕-04—消息存储.png)
...
* 整个文件存储的核心逻辑
  ...
  ![https://note.youdao.com/yws/public/resource/ca36df22924e8930a550116b530b7ca5/xmlnote/227E26665CF8470C8B2B85034832CC33/41492](/img/41492.png)
...
* 整体结构
  ...
  ![https://note.youdao.com/yws/public/resource/ca36df22924e8930a550116b530b7ca5/xmlnote/DC9B54E320B34BC4BE2ADEC91BC173B6/41489](/img/41489.png)
...
* 源码
  ...
  * BrokerController # createBrokerController
    ...
    public static BrokerController createBrokerController(String[] args) {
      ...
      try {
        ...
        //K2 这里可以看出，判断是否基于Dleger技术来管理主从同步和CommitLog的条件就是brokerId设置为-1
  ...
  * BrokerController # start
    ...
    public void start() throws Exception {
      ...
      //K2 Broker中启动了两个Netty服务，这样就可以接受请求了
...
<img src="/img/image-20210804134631596.png" alt="image-20210804134631596" style="zoom:50%;" />
...
![RocketMQ--消息存储--消息发送存储过程](/img/RocketMQ--消息存储--消息发送存储过程.jpg)
...
<img src="/img/image-20210804135150286.png" alt="image-20210804135150286" style="zoom:50%;" />
...
* RocketMQ使用MappedFile、MappedFileQueue来封装存储文件
  ...
  <img src="/img/image-20210805094418230.png" alt="image-20210805094418230" style="zoom:50%;" />

#### MappedFileQueue映射文件队列

* 类图

  <img src="/img/image-20210805095330340.png" alt="image-20210805095330340" style="zoom:50%;" />
...
* 类图
  ...
  <img src="/img/image-20210805102221212.png" alt="image-20210805102221212" style="zoom:50%;" />
...
* 消息组织方式
  ...
  <img src="/img/image-20210806170937690.png" alt="image-20210806170937690" style="zoom:50%;" />
...
* 该文件可以看成是CommitLog关于消息消费的”索引“文件
  ...
  ![image-20210809163424864](/img/image-20210809163424864.png)
...
* 存储格式：为了加速检索速度和节省磁盘空间，不会包含全量信息
  ...
  <img src="/img/image-20210809163701769.png" alt="image-20210809163701769" style="zoom:50%;" />
...
* Index索引文件
  ...
  <img src="/img/image-20210809222532796.png" alt="image-20210809222532796" style="zoom:50%;" />
...
* 类图
  ...
  <img src="/img/image-20210810095103115.png" alt="image-20210810095103115" style="zoom:50%;" />
...
* 结构
  ...
  <img src="/img/image-20210810101445486.png" alt="image-20210810101445486" style="zoom:50%;" />
  ...
  * CommitLogDispatcher
    ...
    * 子类:少了一个，但是平时不接触后面如果需要，再更新
      ...
      * CommitLogDispatcherBuildIndex：更新IndexFile
      ...
      ![image-20210810110536142](/img/image-20210810110536142.png)
...
* CommitLog、ConsumeQueue以及MappedFileQueue和MappedFile的关系
  ...
  ![image-20210810160704490](/img/image-20210810160704490.png)
...
* 加载流程图
  ...
  * MappedFile作用
  ...
  ![RocketMQ--消息存储--消息消费文件和索引文件恢复](/img/RocketMQ--消息存储--消息消费文件和索引文件恢复.jpg)
...
* true的流程图
  ...
  <img src="/img/image-20210812140557954.png" alt="image-20210812140557954" style="zoom:50%;" />
